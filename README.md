...
from DHT22 sensor to MySQL table. The Pyhton program is included with this project under the Pyhton folder. Later during this projecy it was also possible to read the contents trough a web browser. 
...
As mention before I chose the DHT22 sensor for this project, which is both temperature and humitidy sensor. Operating voltage 3.3V-5.5V.
